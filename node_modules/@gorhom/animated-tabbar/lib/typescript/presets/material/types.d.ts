...
export interface MaterialTabBarItemConfig {
    ...
    icon: {
         ...
         */
        component: React.FC<MaterialTabBarIconProps> | React.ComponentClass<MaterialTabBarIconProps> | React.ReactNode;
        /**
         * Icon color.
         * @type {string}
         */
...
export declare type MaterialTabBarItemProps = TabBarItemProps & MaterialTabBarItemConfig & Required<Pick<MaterialTabBarConfig, 'animation' | 'inactiveOpacity' | 'inactiveScale'>>;
