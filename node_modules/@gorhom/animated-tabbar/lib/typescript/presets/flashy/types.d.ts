...
export interface FlashyTabBarItemConfig {
    ...
    icon: {
         ...
         */
        component: React.FC<FlashyTabBarIconProps> | React.ComponentClass<FlashyTabBarIconProps> | React.ReactNode;
        /**
         * Icon color.
         * @type {string}
         */
...
export declare type FlashyTabBarItemProps = TabBarItemProps & FlashyTabBarItemConfig;
