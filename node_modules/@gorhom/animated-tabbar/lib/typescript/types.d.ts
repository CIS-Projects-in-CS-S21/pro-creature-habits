import type { StyleProp, ViewStyle, Insets, Animated as RNAnimated } from 'react-native';
...
export interface TabBarItemProps extends Required<Omit<TabBarConfigurableProps, 'itemInnerSpace' | 'itemOuterSpace' | 'onLongPress' | 'duration' | 'easing'>> {
    /**
...
export declare type AnimatedTabBarProps<T extends PresetEnum = 'bubble'> = {
     ...
     * Root container style.
     */
    style?: StyleProp<ViewStyle> | RNAnimated.WithAnimatedValue<StyleProp<ViewStyle>>;
    /**
