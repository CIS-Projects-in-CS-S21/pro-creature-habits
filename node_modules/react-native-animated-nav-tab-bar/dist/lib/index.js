...
function isIphoneX() {
    var dim = reactNative.Dimensions.get('window');
    return (
    // This has to be iOS
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        tabBarVisible && (React__default['default'].createElement(reactNative.View, { pointerEvents: "box-none", style: floating && overlayStyle },
            React__default['default'].createElement(BottomTabBarWrapper, { style: tabStyle, floating: floating, topPadding: topPadding, bottomPadding: bottomPadding, horizontalPadding: horizontalPadding, tabBarBackground: tabBarBackground, shadow: shadow },
                ...
                React__default['default'].createElement(Dot, { dotCornerRadius: dotCornerRadius, topPadding: topPadding, activeTabBackground: activeTabBackground, style: {
...
var BottomTabNavigator = function (_a) {
    ...
    return (React.createElement(TabBarElement, __assign({}, rest, { state: state, navigation: navigation, descriptors: descriptors, tabBarOptions: finalTabBarOptions, appearence: finalAppearence })));
};
